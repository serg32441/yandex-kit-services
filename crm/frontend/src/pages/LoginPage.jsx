    ...
    <div className="min-h-screen bg-[#F5F5F7] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-[24px] border border-black/[0.06] shadow-[0_2px_8px_rgba(0,0,0,0.04),0_16px_48px_rgba(0,0,0,0.06)] p-8">
          <h1 className="text-[20px] font-semibold text-[#1D1D1F] mb-1 text-center">Войти</h1>
          <p className="text-[14px] text-[#6E6E73] text-center mb-7">Введите данные вашего аккаунта</p>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-600 rounded-xl px-4 py-3 text-[13px] mb-5">
              ...
              <div className="mt-1">
                Нет аккаунта?{" "}
                <Link to="/register" className="underline font-medium">Зарегистрироваться</Link>
              </div>
            </div>
          )}
          ...
          <p className="mt-6 text-center text-[14px] text-[#6E6E73]">
            Нет аккаунта?{" "}
            <Link to="/register" className="text-indigo-600 hover:underline font-medium">Зарегистрироваться</Link>
          </p>
        </div>
      </div>
    </div>
